...
c.InteractiveShellApp.exec_lines = ['from pyslave.magic import *','from pydata.magic import *']
...
#c.InteractiveShell.banner1 = "Python 3.6.5 |Anaconda, Inc.| (default, Mar 29 2018, 13:23:52) [MSC v.1900 32 bit (Intel)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 6.4.0 -- An enhanced Interactive Python. Type '?' for help.\n"

## The part of the banner to be printed after the profile
c.InteractiveShell.banner2 = u"""Welcome to pyslave !

Pyslave magic commands :
* Load instruments : %openall, %closeall, %openinstr, %closeinstr, %listall
* Launch and interact with scripts : %call, %pause, %resume, %abort, %window
* Quick measurement : %monitor, %measure, %capture

Pydata magic commands : %today, %lastday, %rmlast
"""
