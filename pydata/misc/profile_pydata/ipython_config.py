...
c.InteractiveShellApp.exec_lines = ['from pydata.magic import *','import h5py']
...
#c.InteractiveShell.banner1 = "Python 3.7.0 (default, Jun 28 2018, 08:04:48) [MSC v.1912 64 bit (AMD64)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 6.5.0 -- An enhanced Interactive Python. Type '?' for help.\n"

## The part of the banner to be printed after the profile
c.InteractiveShell.banner2 = 'Loading magic pydata functions'
